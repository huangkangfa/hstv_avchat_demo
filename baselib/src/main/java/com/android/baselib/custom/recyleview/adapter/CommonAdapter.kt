package com.android.baselib.custom.recyleview.adapter
...
class SingleAdapter<ITEM>(
    ...
    constructor(
        ...
        itemClick: (ITEM) -> Unit = {}
    ) : this(items, layoutResId, initHolder) {
...
class MultiAdapter<ITEM : ListItemI>(
...
fun <ITEM : ListItemI> RecyclerView.setUP(
    items: List<ITEM>,
...
private fun <ITEM : ListItemI> getListItem(
    listItems: Array<out ListItem<ITEM>>,
    type: Int
): ListItem<ITEM>? {
