package com.android.hsdemo.ui.entrance.vm
    ...
    fun initButtonFocusChangeListener(views: ArrayList<View>) {
        for (view in views) {
            view.onFocusChangeListener = OnFocusChangeListener { v, focus ->
                ...
                if (activity != null) {
                    if (focus) {
                        v.background = activity.getDrawable(R.drawable.button_bg_focus)
                    } else {
                        v.background = activity.getDrawable(R.drawable.button_bg)
                    }
                }
            }
        }
